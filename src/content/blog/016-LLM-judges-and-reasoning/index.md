...
Some quality issues in AI LLM text are deterministic (that is, they can be easily evaluated with code). For example, if you want to check if your LLM output contains em dashes -> look for the em dashes in text. Some quality issues are issues with facts. 
